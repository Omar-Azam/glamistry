            ...
            <div class="col-lg-8">
                <div class="subscription-form">
                    ...
                    <form action="#" class="row g-3">
                        <div class="col-auto">
                            <input type="text" class="form-control" placeholder="Enter your name" value="<?php if(isset($_SESSION['user']['id'])){echo $_SESSION['user']['name'];}?>">
                        </div>
                        <div class="col-auto">
                            <input type="email" class="form-control" placeholder="Enter your email" value="<?php if(isset($_SESSION['user']['id'])){echo $_SESSION['user']['email'];}?>">
                        </div>
                        <div class="col-auto">
